...
Речь идёт в основном о моём опыте РП от 3 лица с нарраторством и на английском языке в SillyTavern. Я ролю на микрокарточке до 600 токенов и микропресете с активными модулями до 150 токенов без CSS и инфотабов (отупляют). Ещё я душниша. Если вам и так норм, не напрягайтесь.
