# Как промтить, чтобы бот НЕ ЛОМАЛСЯ

![Alt Tag](https://i.postimg.cc/441hg7dM/IMG-20251203-161721-770.jpg)

# Дисклеймер
Не претендую на истину, я не эксперт и просто пишу о том, как делаю я. Речь идёт о моём личном опыте РП от 3 лица с нарраторством и на английском языке в SillyTavern. 

Я ролю на мелкокарточке до 1000 токенов и мелкопресете с активными модулями до 500 токенов без CSS, инфотабов, меморибуков и прочих инъекций в промты (отупляют иишки/прожирают ключи). 

Ещё я душнила. Если вам и так норм, не напрягайтесь. Если вам виднее, делайте как вам виднее. У меня свои ролки, персы, вкусы и предпочтения, а у вас свои.

# Качественный промтинг
...
Ещё пресет может использоваться для внедрения своей думалки/think (размышлений) в модель (а её личный think рекомендуется вырезать регексом). Но мне этот метод не зашёл, и Gemini, моя основная модель, через раз игнорит думалку юзера, так что я это больше не использую.

Если вы хотите, чтобы вашу кастомную думалку не игнорили, впишите в префикс "Начинать ответ с..." свой тег на думалку, например, <think>, и режьте регексом на <think> то лишнее, что вылезает в пост. 

Своя думалка позволяет более точечно настроить каждый ответ модели, но если вам нужно максимум творчества, то хз, зачем это юзать, всё это может ломаться и отуплять модель.
...
Исключение для думалки 1: есть чел, который использует думалку, чтобы добавить максимальный хаос в каждый пост и ролит в формате орного чата на ру языке. В думалку он пишет хаотик-дичь. Можете пойти по его стопам или нет, зависит от вашего желания заморочиться и типа РП.
...
# Контакты автора
> Я не эксперт и могу заблуждаться, по идеям, конструктивной критике т.д. мой Телеграм про AI и RP [@sillytavern1](https://t.me/sillytavern1)
